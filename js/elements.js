const ellies = {
  ...
  "edges":[
    ...
    { data: { id: '1', source: 'n1', target: 'n3', name: "Go West" } },
    { data: { id: '2', source: 'n1', target: 'n4', name: "Go North" } },
    { data: { id: '3', source: 'n2', target: 'n5', name: "Go Go forward" } },
    { data: { id: '4', source: 'n3', target: 'n6', name: "To room 2" } },
    { data: { id: '5', source: 'n4', target: 'n7', name: "To room 3" } },
    { data: { id: '6', source: 'n6', target: 'n8', name: "To room 4" } },
    { data: { id: '7', source: 'n7', target: 'n8', name: "To room 4" } },
    { data: { id: '8', source: 'n5', target: 'n9', name: "To room 5" } },
    { data: { id: '9', source: 'n9', target: 'n8', name: "To room 4" } },
    { data: { id: '10', source: 'n6', target: 'n7', name: "To room 3" } },
    { data: { id: '11', source: 'n8', target: 'n7', name: "To room 3" } },
    { data: { id: '12', source: 'n8', target: 'n6', name: "To room 2" } },
